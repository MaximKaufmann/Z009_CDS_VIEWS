@AbapCatalog.sqlViewName: 'ZCUBEFLIGHTB009'
@AbapCatalog.compiler.compareFilter: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Cube FlightBookings'

@Analytics.dataCategory: #CUBE

define view Z_Cube_FlightBookings_009
  ...
  association [0..1] to Z_Dimension_Connection_009   as _Connection   on  $projection.Airline          = _Connection.Airline
                                                                      and $projection.FlightConnection = _Connection.FlightConnection
  association [0..1] to Z_Dimension_Customer_009     as _Customer     on  $projection.Customer = _Customer.Customer
  association [0..1] to Z_Dimension_TravelAgency_009 as _TravelAgency on  $projection.TravelAgency = _TravelAgency.TravelAgency
{
  /** DIMENSIONS **/
